...
const features = [
  ...
  { title: 'Design systems', icon: 'grid-02', visual: gradient('#0984E3', '#6C5CE7'), imageAspectRatio: '10/6', description: 'Tokenised, themeable component kits.' },
  { title: 'Client work', icon: 'library', visual: gradient('#E17055', '#FDCB6E'), imageAspectRatio: '10/6', description: 'Brand, editorial, and product design.' },
]

export const WithHeaderAndCtas = () => (
  <FeaturesCardSection
...
export const CardsOnly = () => (
  <FeaturesCardSection features={features} />
)
