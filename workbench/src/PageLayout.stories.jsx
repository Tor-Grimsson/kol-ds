...
import { PageLayout, PageSection } from '@kolkrabbi/kol-framework'
...
/* PageLayout renders an <Outlet/>, so it must sit in a layout <Route>. */
const Page = ({ title }) => (
  <div style={{ padding: 32 }}>
    <PageSection
      ...
      label="01 — overview"
      title={title}
      body="Sample page content rendered through the PageLayout Outlet."
    />
  </div>
)
...
export const Default = () => (
  <MemoryRouter initialEntries={['/']}>
    <Routes>
      <Route element={<PageLayout navTree={navTree} getActivePage={getActivePage} />}>
