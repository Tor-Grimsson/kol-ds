...
## ✅ RESOLUTION — 2026-09-01 · kol-controls@0.3.0
...
**Remainder here:** none — kol-monitor bump kol-theme@0.126.0 + kol-component@0.159.0 + kol-controls@0.3.0; TextInput → <Input size="xs" onCommit>, PanelDropdown → <Dropdown size="xs" variant="grey"> under PanelLabel, Selector → <Stepper size="xs" options> reading e.target.value; retire the three seams to _tmp/; re-shoot /dev/controls-ab.
