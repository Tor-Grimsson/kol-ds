...
## ✅ RESOLUTION — 2026-09-02 · kol-component@0.161.0
...
**Remainder here:** none — kol-monitor bump kol-component@0.161.0; Recorder ×3 + Raster ×1 → <Stepper size="xs" layout="inline" options … className="uppercase"> reading e.target.value; retire parametric/Selector.jsx to _tmp/; re-shoot.
