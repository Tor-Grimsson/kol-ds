...
---
## 📌 ARCHIVED 2026-07-30 — source pointer, import-on-need only
User ruling: not a wholesale import; ignore unless a specific need names it. Source of truth: `~/dev/projects/kol-ds-type/kol-type-tools/kol-para-type/src/` (NOT the editor repo). If a need arises, this spec is the recreate-from brief — dedicated session only.
