...
| Package | Version | Job |
|---|---|---|
| `@kolkrabbi/kol-theme` | **0.9.0** | Foundation CSS — tokens, type classes, all component chrome (`.kol-btn*`, `.kol-prose`, per-domain sheets) |
...
| `@kolkrabbi/kol-chess` | **0.4.0** | Chess apparatus — interactive board (click-to-move), 3 piece sets, playback/notation/sidelines, `./data` adapter |
