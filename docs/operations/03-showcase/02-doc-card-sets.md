---
title: Doc + card sets — one role system, two entry points
type: plan
status: active
updated: 2026-07-28
description: Scoping for two theme-level type-role sets — kol-doc-* (content roles shared by prose and authored chrome) and kol-card-* (card text roles) — plus the packaged Doc* composer family in kol-workshop. Opt-in everywhere; no forced migration.
phases:
