...
- **Mined usage** — [`../06-usage/<Name>.md`](../06-usage/) — real, attributed examples from ~25 consumer apps (generated by `scripts/extract-usage.mjs`; regenerate after consumer apps change)
