...
- **Category:** molecules
- **Real-world usages found:** 31 across 5 files in 4 apps
- **Used in:** kol-client-acyr-website, kol-client-kolkrabbi, kol-draw-3d, kol-editor
...
From `kol-client/kol-client-acyr-website/apps/website/src/pages/site/Checkout.jsx`:
