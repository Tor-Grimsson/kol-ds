...
related:
  ...
  - "[[../plan|execution plan]]"
  - "[component placement](../../../docs/documentation/02-components/02-placement.md)"
---

# Brand-app extraction scan — promotion candidates

E3 deliverable: full sweep of `apps/brand`'s styleguide components (24 pieces read). Categories follow [component placement](../../../docs/documentation/02-components/02-placement.md). **Nothing here ports without approval** — except the Swatch, which the backlog itself ordered (E2, already ported to `showcase/src/lib/Swatch.jsx`).
