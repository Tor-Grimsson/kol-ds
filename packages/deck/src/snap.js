/* Lifted verbatim from kol-fxr `src/editor/compose/snap.js` (2026-09-03) —
 * the one piece of the compose editor a deck needs as-is. Pure functions;
 * SlideStage owns the live drag math and draws the guides. */
