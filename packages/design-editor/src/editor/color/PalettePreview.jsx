  ...
  'applied-card': (p) => (
    <div className="flex h-full gap-2 p-2" style={{ background: p.light }}>
      ...
      <div className="flex flex-[2] flex-col gap-2">
        <div className="relative flex-1 rounded-sm border border-oq-08" style={{ background: p.light }}>
...
export default function PalettePreview({ layoutId, palette, bgOn }) {
  ...
  return (
    <div
      aria-hidden="true"
      className="pointer-events-none select-none rounded border border-oq-08 p-3"
