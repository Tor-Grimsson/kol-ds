...
import { PaletteHarmonyWheel, HARMONIES, harmonyById, ColorInputRow } from '@kolkrabbi/kol-component'
...
function PaletteModalBody({ onClose, layoutId, setLayoutId, harmonyId, setHarmonyId }) {
  const {
    poolId, modeId, colors, locks, bgOn, palette,
  ...
  return (
    ...
    <FullscreenOverlay open onClose={onClose}>
      ...
      >
        <div className="flex h-10 items-center justify-between border-b border-oq-08 px-5">
          <span className="kol-helper-12 text-emphasis">Palette</span>
          {/* the DS CloseButton — a 12px glyph with no padding was a 12×12
              target in a 40px header (editor-chrome-review, 2026-09-03) */}
