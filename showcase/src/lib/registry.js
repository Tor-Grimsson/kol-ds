...
const FUNCTION_MAP = {
  ...
  MediaViewer: 'media', Figure: 'media', OverlayGlassPanel: 'display', EmptyState: 'feedback',
  HlsVideo: 'media', AssetGrid: 'structure', FeatureSplit: 'structure',
  CurveOverlay: 'input', RotaryDial: 'input',
  DocsToc: 'navigation', TabsRow: 'navigation',
  PriceDisplay: 'display', ProsePreview: 'display', TypeSample: 'display', TypeSpecCard: 'display', SpecList: 'display',
  ShapeDropdown: 'action', ErrorBoundary: 'feedback',
  SearchInput: 'input', ShellDrawer: 'overlay', ShellSearchOverlay: 'overlay', ShellHeader: 'structure',
  ...
  AsciiCursor: 'overlay', ColorLoader: 'display', LoaderOverlay: 'overlay',
  ...
  WorkCard: 'display', WorkListItem: 'display', WorkViewToggle: 'input',
