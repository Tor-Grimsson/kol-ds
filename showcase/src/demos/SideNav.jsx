...
export default function SideNavDemo() {
  ...
  // the preview and neutralise the viewport sizing.
  return (
    <div className="h-80 w-60 overflow-hidden rounded-[var(--kol-radius-sm)] border border-fg-12 [&_.kol-sidenav]:static [&_.kol-sidenav]:h-full">
