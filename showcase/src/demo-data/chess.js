// Showcase-local chess adapter. The DS package is presentation-only as of 0.6.0 —
// it ships no data and never fetches, so the showcase supplies its own, exactly as a
// consuming app does. Demo set is bundled; the full archive comes from the public CDN.
...
const CDN_BASE = 'https://b2.kolkrabbi.io/website/data-library/chess-data'
