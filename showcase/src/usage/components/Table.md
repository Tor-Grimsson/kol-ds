...
- **Category:** organisms
- **Real-world usages found:** 128 across 41 files in 10 apps
- **Weighted inbound:** 133★ across 41 edges — 10×4★ · 31×3★
- **Used in:** kol-client, kol-client-ac, kol-client-acyr-website, kol-client-canalix, kol-client-kolkrabbi, kol-editor, kol-editor-radar, kol-labs-monorepo, kol-modulator, kol-website
